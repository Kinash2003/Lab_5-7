...
if choice == "y" or choice == "Y":
    accessToken = "ZWZlNGViMTctNTY3Ny00NjQ4LTkxMjEtZGM3MGQ4ZTU4OThiZTNjMmRhZjUtMzA0_PE93_f451a09f-5fe6-4b74-a13a-2fde64738081"
...
for message in messages:
    if message["text"].find(messageText) != -1:
        ...
        print("PersonEmail: " + message["personEmail"])
...
#     - Else display a message with the number of messages found (messageCounter) using this criteria
    if messageCounter == 0:
        ...
        print(f"The number of messages: {messageCounter}")
